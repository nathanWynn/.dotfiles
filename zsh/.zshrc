...
# nuke script
alias nuke_rn="cd ~/workspace/prizepicks-rn && rm -rf node_modules; rm -rf .expo; rm -rf ios/; rm -rf android/; rm -rf ~/Library/Developer/Xcode/DerivedData; yarn;"
export PATH="/opt/homebrew/opt/libpq/bin:$PATH"
alias mk9s="cd ~/workspace/mini && devbox run k9s"
